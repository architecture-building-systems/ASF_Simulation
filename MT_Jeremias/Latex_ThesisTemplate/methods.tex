	...
	\label{s:simulationFramework}
		...
		\subsection{Parametric Model}
			...
			\begin{figure}[ht] %h can be omitted for better page layout
				...
				\caption{Visualization of the parametric simulation model}
