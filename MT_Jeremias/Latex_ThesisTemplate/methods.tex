...
\label{c:methodology}
	...
	\section{Case Study}
		...
		\footnotetext{Only the EnergyPlus analysis with DIVA is able to include reflectance. Ladybug does not take reflectance into account.}
		\footnotetext[2]{This value represents the distance from the panels used for the radiation calculations.}
