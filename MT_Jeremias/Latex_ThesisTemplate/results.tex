...
Figure \ref{fig:carpetplot_energy} shows the net energy use at these optimum angles. It can be seen that heating (a) is mainly dominant in the winter and in the mornings, cooling (b) is primarily needed in the summer afternoons, lighting (c) at hours of low or no solar insolation, whereas PV electricity production is dominant at hours with high solar insolation. (e) shows the total building energy demand and (f) visualizes the net energy demand including the PV electricity production. It can be seen that there is a net negative energy demand for most sunlit hours, i.e. the ASF is generating more energy than is used by the building. 
