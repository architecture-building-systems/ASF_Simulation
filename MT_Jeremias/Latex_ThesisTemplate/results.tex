...
\label{s:baseCase}
	...
	\begin{figure*}
		\begin{center}
		\includegraphics[width=\textwidth, trim= 1cm 0.5cm 1cm 1.3cm,clip]{monthly_altitude.pdf}
	...
	\begin{figure*}
		\begin{center}
		\includegraphics[width=\textwidth, trim= 1cm 0.5cm 1cm 1.3cm,clip]{monthly_azimuth.pdf}
