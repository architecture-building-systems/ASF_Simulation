...
\label{a:PV}
	...
	\begin{figure*}[hb]
		\begin{center}
		\includegraphics[width=\textwidth, trim= 0cm 0cm 0cm 0cm,clip]{PV_angles}
	...
	\begin{figure*}
		\begin{center}
		\includegraphics[width=\textwidth, trim= 3cm 2cm 2cm 0cm,clip]{PV_power}
	...
	\begin{figure*}
		\begin{center}
		\includegraphics[width=\textwidth, trim= 3cm 2cm 2cm 0cm,clip]{PV_efficiency}
