...
\label{ch:motivation}
	...
	\begin{figure}[ht] %h can be omitted for better page layout
		\begin{center}
		\includegraphics[width=0.6\textwidth, trim= 0cm 0cm 0cm 0cm,clip]{explodedASFV2}
