...
The simulation is conducted within the Rhino / Grasshopper environment using the Ladybug for the Photovoltaic Analysis and HoneyBee / EnergyPlus for the building energy analysis. From this simulation we can determine the optimum position and orientation of the PV panels, not only for optimal energy harvest, but also for the overall balance of the room.
