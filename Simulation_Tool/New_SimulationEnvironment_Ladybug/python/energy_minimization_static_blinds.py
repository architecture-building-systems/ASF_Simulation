...
def RC_Model (optimization_type, paths ,building_data, weatherData, BuildingRadiationData_HOY, PV, NumberCombinations, combinationAngles, BuildingProperties, SimulationOptions, occupancy, Q_human, ANGLES):
    ...
    from optimzeTemperatureFunction_static_blinds import optimzeTemp, checkEqual
    from ActuationEnergyCalc_classic import ActuationDemand
    ...
    threshold_blinds = BuildingProperties['blind_threshold']
    blinds_control = BuildingProperties['blinds_control']
    ...
    E_HCL_closed= {}
    Data_HC_HOY_closed= {}
    Data_Heating_HOY_closed= {}
    Data_Cooling_HOY_closed= {}    
    Data_Lighting_HOY_closed=  {}   
    Data_T_in_HOY_closed = {}
    Data_T_air_HOY_closed = {}
    Actuation_closed = {}
    Data_H_elec_closed = {}
    Data_H_fossil_closed = {}
    Data_C_elec_closed= {}
    E_tot_elec_closed = {}
    E_HCL_elec_closed = {}
    ...
    BuildingRadiationData_HOY_closed = {}
    ...
    for hour_of_year in range(0,8760):
        ...
        E_tot_closed[hour_of_year] = {}
        E_HCL_closed [hour_of_year] = {}
        Data_HC_HOY_closed[hour_of_year] = {}
        Data_Heating_HOY_closed[hour_of_year] = {}
        Data_Cooling_HOY_closed[hour_of_year] = {}    
        Data_Lighting_HOY_closed[hour_of_year] =  {}   
        Data_T_in_HOY_closed[hour_of_year] = {}
        Data_T_air_HOY_closed[hour_of_year] = {}
        Actuation_closed[hour_of_year] = {}
        Data_H_elec_closed[hour_of_year] = {}
        Data_H_fossil_closed[hour_of_year] = {}
        Data_C_elec_closed[hour_of_year] = {}
        E_tot_elec_closed[hour_of_year] = {}
        E_HCL_elec_closed[hour_of_year] = {}
        ...
        BuildingRadiationData_HOY_closed[hour_of_year] = {}
    
    tic = time.time()
    NumberCombinationsRange = range(0, NumberCombinations)

    #run for every hour of year the RC-Model    
    for hour_of_year in range(0,8760):
        
        NumbCombRange = range(0, NumberCombinations)
        ...
        for comb in NumberCombinationsRange:
            ...
            Data_C_elec[hour_of_year][comb] = Office.coolingSysElectricity
            ...
            E_tot[hour_of_year][comb]=  Data_Heating_HOY[hour_of_year][comb] + Data_Cooling_HOY[hour_of_year][comb] + Data_Lighting_HOY[hour_of_year][comb] + Actuation[hour_of_year][comb] - hourlyData[hour_of_year]['PV']
            ...
            E_tot_elec[hour_of_year][comb] =  Data_H_elec[hour_of_year][comb] + Data_C_elec[hour_of_year][comb] + Data_Lighting_HOY[hour_of_year][comb] + Actuation[hour_of_year][comb] - hourlyData[hour_of_year]['PV']
        ...
        if blinds_control == True: 
            if (max(BuildingRadiationData_HOY[hour_of_year])/Office.Fenst_A) >= threshold_blinds:
                Threshold_Flag = True
                Max_radi_window = max(BuildingRadiationData_HOY[hour_of_year])
                closed_comb = []
                NumberCombinations_iteration = 0
                for all_comb in ANGLES[:-1]: 
                    if all_comb[0] == 100: 
                        closed_comb.append(NumberCombinations_iteration)
                        E_tot_closed[hour_of_year][NumberCombinations_iteration] = E_tot[hour_of_year][NumberCombinations_iteration]
                        E_HCL_closed [hour_of_year][NumberCombinations_iteration] = E_HCL[hour_of_year][NumberCombinations_iteration]
                        Data_HC_HOY_closed[hour_of_year][NumberCombinations_iteration] = Data_HC_HOY[hour_of_year][NumberCombinations_iteration]
                        Data_Heating_HOY_closed[hour_of_year][NumberCombinations_iteration] = Data_Heating_HOY[hour_of_year][NumberCombinations_iteration]
                        Data_Cooling_HOY_closed[hour_of_year][NumberCombinations_iteration] = Data_Cooling_HOY[hour_of_year][NumberCombinations_iteration]   
                        Data_Lighting_HOY_closed[hour_of_year][NumberCombinations_iteration] = Data_Lighting_HOY[hour_of_year][NumberCombinations_iteration]
                        Data_T_in_HOY_closed[hour_of_year][NumberCombinations_iteration] = Data_T_in_HOY[hour_of_year][NumberCombinations_iteration]
                        Data_T_air_HOY_closed[hour_of_year][NumberCombinations_iteration] = Data_T_air_HOY[hour_of_year][NumberCombinations_iteration]
                        Actuation_closed[hour_of_year][NumberCombinations_iteration] = Actuation[hour_of_year][NumberCombinations_iteration]
                        Data_H_elec_closed[hour_of_year][NumberCombinations_iteration] = Data_H_elec[hour_of_year][NumberCombinations_iteration]
                        Data_H_fossil_closed[hour_of_year][NumberCombinations_iteration] = Data_H_fossil[hour_of_year][NumberCombinations_iteration]
                        Data_C_elec_closed[hour_of_year][NumberCombinations_iteration] = Data_C_elec[hour_of_year][NumberCombinations_iteration]
                        E_tot_elec_closed[hour_of_year][NumberCombinations_iteration] = E_tot_elec[hour_of_year][NumberCombinations_iteration]
                        E_HCL_elec_closed[hour_of_year][NumberCombinations_iteration] = E_HCL_elec[hour_of_year][NumberCombinations_iteration]
                        BuildingRadiationData_HOY_closed[hour_of_year][NumberCombinations_iteration] = BuildingRadiationData_HOY[hour_of_year][NumberCombinations_iteration]
                    else:
                        #BuildingRadiationData_HOY_closed[hour_of_year][NumberCombinations_iteration] = 0
                        pass
                        #BuildingRadiationData_HOY_closed[hour_of_year][NumberCombinations_iteration]= 0
                    NumberCombinations_iteration += 1
                #NumberCombinations = len(NumberCombinationsRange)
                #for comb in NumberCombinationsRange:

                E_tot[hour_of_year] = E_tot_closed[hour_of_year]
                E_HCL[hour_of_year] = E_HCL_closed[hour_of_year] 
                Data_HC_HOY[hour_of_year]  = Data_HC_HOY_closed[hour_of_year]
                Data_Heating_HOY[hour_of_year] = Data_Heating_HOY_closed[hour_of_year] 
                Data_Cooling_HOY[hour_of_year] =Data_Cooling_HOY_closed[hour_of_year] 
                Data_Lighting_HOY[hour_of_year] = Data_Lighting_HOY_closed[hour_of_year]
                Data_T_in_HOY[hour_of_year] = Data_T_in_HOY_closed[hour_of_year]
                Data_T_air_HOY[hour_of_year] = Data_T_air_HOY_closed[hour_of_year]
                #Actuation[hour_of_year] = Actuation_closed[hour_of_year]
                Data_H_elec[hour_of_year] = Data_H_elec_closed[hour_of_year]
                Data_H_fossil[hour_of_year] = Data_H_fossil_closed[hour_of_year]
                Data_C_elec[hour_of_year] = Data_C_elec_closed[hour_of_year]
                E_tot_elec[hour_of_year] = E_tot_elec_closed[hour_of_year]
                E_HCL_elec[hour_of_year] = E_HCL_elec_closed[hour_of_year]
            else: 
        ...
        """if blinds_control == True: 
            if max(BuildingRadiationData_HOY[hour_of_year]) > threshold_blinds: #max(hourlyData[hour_of_year]['PV']) != 0:
                    #get key with min value from the dictionary
                    closed_comb = []
                    NumberCombinations_iteration = 0
                    for all_comb in ANGLES: 
                        if all_comb[0] == 100: 
                            closed_comb.append(NumberCombinations_iteration)
                            NumberCombinations_iteration += 1
                        else: 
                            NumberCombinations_iteration += 1
                    NumberCombinationsRange = closed_comb
                    #NumberCombinations = len(NumberCombinationsRange)
                    for comb in NumberCombinationsRange: 
        ...
        if optimization_type == 'E_total':
            ...
            if max(hourlyData[hour_of_year]['PV']) != 0:
                ...
                if equal == True:
                    ...
                    #print "BestComb PV != 0, Equal=True, optimizedTemp", BestComb
                else:
                    pass
                
                BestCombKey = BestComb    
                #print "BestCombKey PV != 0", BestCombKey
                ...
                if equal == False:
                    ...
                    BestComb = optimzeTemp(DataTemp = Data_T_in_HOY[hour_of_year], Tmax = Tmax, Tmin = Tmin)           
                    BestCombKey = BestComb
                    #print "BestCombKey PV = 0, Equal= False, optimizedTemp", BestCombKey
                    
                elif equal == True: #PV = 0, Temp are equal
                    BestComb = 0 #chose random Temp
                    BestCombKey = NumberCombinations # make colormap grey
                    #print "BestCombKey PV = 0, Equal= True, optimizedTemp", BestCombKey
            ...
            if max(BuildingRadiationData_HOY[hour_of_year]) != 0:
                if Threshold_Flag:
                    BestComb = max(BuildingRadiationData_HOY_closed[hour_of_year], key=lambda comb: BuildingRadiationData_HOY_closed[hour_of_year][comb])
                    """while BuildingRadiationData_HOY_closed[hour_of_year][BestComb]>= threshold_blinds: 
                        BuildingRadiationData_HOY_closed[hour_of_year][BestComb] = 0
                        BestComb = max(BuildingRadiationData_HOY_closed[hour_of_year], key=lambda comb: BuildingRadiationData_HOY_closed[hour_of_year][comb])
                        if max(BuildingRadiationData_HOY_closed[hour_of_year]) == 0: 
                            print "Thrshold for blinds is too small, even with closed blinds """
                    BestCombKey = BestComb
                else: 
                ...
                if equal == False:
                    ...
                    BestComb = 0 #chose random Temp
                    BestCombKey = NumberCombinations # make colormap grey
            if hour_of_year == 4352:
                print "BuildingRadiationData_HOY_closed", BuildingRadiationData_HOY_closed[hour_of_year]
                print "BestComb", BestComb
                print "BuildingRadiationData_HOY", BuildingRadiationData_HOY[hour_of_year]
            ...
            if max(hourlyData[hour_of_year]['PV']) != 0:
                ...
                if equal == False:
                    ...
                    BestComb = 0 #chose random Temp BestComb = NumbCombRange[0] #
                    BestCombKey = NumberCombinations # make colormap grey
        ...
        results_building_simulation[hour_of_year]['PV']  = hourlyData[hour_of_year]['PV']
        ...
        BuildingSimulationELEC[hour_of_year]['PV']  = hourlyData[hour_of_year]['PV']
