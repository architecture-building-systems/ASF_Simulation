...
def RC_Model (optimization_type, paths ,building_data, weatherData, BuildingRadiationData_HOY, PV, combinationAngles, \
    ...
    for hour_of_year in range(start,end+1):
        ...
        for comb in range(0, NumberCombinations):
            ...
            E_tot[hour_of_year][comb]=  Data_Heating_HOY[hour_of_year][comb] + Data_Cooling_HOY[hour_of_year][comb] + Data_Lighting_HOY[hour_of_year][comb] + Actuation[hour_of_year][comb] - hourlyData[hour_of_year]['PV'][0]
            ...
            E_tot_elec[hour_of_year][comb] =  Data_H_elec[hour_of_year][comb] + Data_C_elec[hour_of_year][comb] + Data_Lighting_HOY[hour_of_year][comb] + Actuation[hour_of_year][comb] - hourlyData[hour_of_year]['PV'][0]
        ...
        results_building_simulation[hour_of_year]['PV']  = hourlyData[hour_of_year]['PV'][0] * (-1)
