            ...
            for HOD in hour_in_month[monthi]:
                ...
                for x_angle in XANGLES:
                    for y_angle in YANGLES:
                        ...
                        comb_data={"percent_blinds":x_angle,
                                   "tilt_angle":y_angle,
                                   "HOD":HOD,
                                   "Month":monthi
                                   }
                        ...
                        with open('comb_static.json','w') as f:
                        ...
                        while not os.path.exists(os.path.join(paths['radiation_results'],'RadiationResults' +'_'+  str(int(HOD)) + '_' + str(monthi)  + '.csv')):
                            time.sleep(1)
