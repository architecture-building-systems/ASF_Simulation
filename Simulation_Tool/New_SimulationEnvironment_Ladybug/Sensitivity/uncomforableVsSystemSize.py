"""
=========================================
Comparison of uncomfortable hours vs system size
=========================================
"""
...
if __name__=='__main__':
	...
	phi_max_A_f_list = np.arange(1000.,10000.,100.)
	all_results=pd.DataFrame({'Name': []})
	all_results.set_index(['Name'], inplace=True)

	for phi_max_A_f in phi_max_A_f_list:
		
		BuildingProperties["phi_c_max_A_f"] = phi_max_A_f
		BuildingProperties["phi_h_max_A_f"] = phi_max_A_f
		print phi_max_A_f
		...
		current_result = ASF.yearlyData.T
		current_result['Name'] = phi_max_A_f
		...
		name = 'UncomfortableHours_' + SimulationData.get('DataFolderName') + '_' + timestr + '.csv'
