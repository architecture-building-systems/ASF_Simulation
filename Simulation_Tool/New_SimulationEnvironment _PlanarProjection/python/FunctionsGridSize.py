...
def runRadiationCalculation(SimulationPeriode, paths, XANGLES, YANGLES, hour_in_month, FolderName, panel_data, NumberCombinations, createPlots, start, end, GridSize):
