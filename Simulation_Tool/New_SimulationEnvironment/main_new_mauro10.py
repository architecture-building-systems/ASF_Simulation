...
for HOY in range(start,end):
    ...
    if HOY_night[HOY] != True:
        ...
        BuildingRadiationData_HOY[HOY] = NumberCombinations * [0]
...
for hour_of_year in range(start,end):
    ...
    Data_T_in, Data_Heating_HOY, Data_Cooling_HOY, Data_Lighting_HOY = main_RC_model(start, end, HOY_night, NumberCombinations, BuildingRadiationData_HOY,paths['epw_name'],paths['Radiation_Buidling'],paths['Occupancy'])
