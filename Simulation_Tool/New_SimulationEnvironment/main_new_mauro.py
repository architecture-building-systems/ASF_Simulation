...
def main ():
    ...
    BuildingRadiationData_HOD = CalculateRadiationData(XANGLES, YANGLES, paths, daysPerMonth, hour_in_month)
    ...
    #optimization_Types = ['E_total'] #Optimization for the best angle combination to minimize the overall energy consumption
    optimization_Types = ['E_total','Heating','Cooling', 'SolarEnergy', 'E_HCL', 'Lighting']
    #optimization_Types = ['Heating']
    #optimization_Types = ['Cooling']
    #optimization_Types = ['SolarEnergy']
    #optimization_Types = ['E_HCL']
    #optimization_Types = ['Lighting']
    ...
    for optimizationType in optimization_Types:
        ...
        hourlyData[optimizationType], ResultsBuildingSimulation[optimizationType] = energy_minimization(
