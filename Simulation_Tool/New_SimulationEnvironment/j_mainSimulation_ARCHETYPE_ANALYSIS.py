...
#################################################################---NEW
#Set DEFAULT building properties for RC-Model simulator
BuildingProperties={
...
def MainCalculateASF(SimulationData, PanelData, BuildingData, BuildingProperties, SimulationOptions):
    ...
    FolderName = initializeSimulation(SimulationData = SimulationData) ####change
    ...
    BuildingProperties = initializeBuildingSimulation(
                             building_data = BuildingData,    ####change
                             BuildingProperties = BuildingProperties) ####change
                    
    
    paths, weatherData, SunTrackingData = setPaths(
                              geoLocation = SimulationData['geoLocation'], 
                              Occupancy = SimulationOptions['Occupancy'], ####change
...
#call fuction
for bp in BuildingProperties:
ResultsBuildingSimulation, monthlyData, yearlyData, x_angles = MainCalculateASF(SimulationData, PanelData, BuildingData, bp, SimulationOptions)