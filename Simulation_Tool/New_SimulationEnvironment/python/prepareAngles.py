    ...
    for month in range(1,13):
        ...
        for hour in range(0,24):
            ...
            for day in range(1,daysPerMonth[month-1]+1):
                ...
                BestKey_HOD[month][hour]= np.append(BestKey_HOD[month][hour], Building_Simulation_df[evaluationType][HOY][0])
                key_dict[month][hour][day] = Building_Simulation_df[evaluationType][HOY][0]
