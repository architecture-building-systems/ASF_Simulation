...
def createCarpetPlot (monthlyData, roomFloorArea):
...
def createCarpetPlotXAngles(x_angle_array, hour_in_month):  
   
    fig = plt.figure(figsize=(16, 8))
    #    plt.suptitle("Optimum Altitude and Azimuth Orientation", size=16)
    plt.subplot(2,3,1)
    carpetPlotMask(X = x_angle_array['Heating'], z_min = 0, z_max= 90, title = '(a) Heating Demand', hour_in_month = hour_in_month)
    plt.ylabel("Hour of the Day",size=14)
    
    plt.subplot(2,3,2)
    carpetPlotMask(X = x_angle_array['Cooling'], z_min = 0, z_max= 90, title = '(b) Cooling Demand', hour_in_month = hour_in_month)
    ...
    plt.subplot(2,3,6)   
    carpetPlotMask(X = x_angle_array['E_total'], z_min = 0, z_max= 90, title = '(f) Net Demand Including PV', hour_in_month = hour_in_month)
    plt.xlabel("Month of the Year",size=14)
...
def createCarpetPlotYAngles(y_angle_array, hour_in_month):  
   
    fig = plt.figure(figsize=(16, 8))
    #    plt.suptitle("Optimum Altitude and Azimuth Orientation", size=16)
    plt.subplot(2,3,1)
    carpetPlotMask(X = y_angle_array['Heating'], z_min = -45, z_max= 45, title = '(a) Heating Demand', hour_in_month = hour_in_month)
    plt.ylabel("Hour of the Day",size=14)
    
    plt.subplot(2,3,2)
    carpetPlotMask(X = y_angle_array['Cooling'], z_min = -45, z_max= 45, title = '(b) Cooling Demand',hour_in_month = hour_in_month)
    ...
    plt.subplot(2,3,6)   
    carpetPlotMask(X = y_angle_array['E_total'], z_min = -45, z_max= 45, title = '(f) Net Demand Including PV', hour_in_month = hour_in_month)
    plt.xlabel("Month of the Year",size=14)
