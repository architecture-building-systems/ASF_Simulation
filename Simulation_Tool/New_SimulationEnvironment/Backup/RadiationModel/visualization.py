...
#    writer.SetFileName("C:\Users\Assistenz\Desktop\Mauro\screenshot.png")
...
if __name__ == '__main__':
    ...
    listSTL = ['ASF_' + str(x_angle) + '_' + str(y_angle), 'Window', 'Room', 'Context']#, 'background2', 'background3']
    listSen = ['ASF1_' + str(x_angle) + '_' + str(y_angle),
    ...
    if PATH == "1":
        ...
        in_path = r'C:\Users\Assistenz\Desktop\Mauro\radiation_visualization\ASF_45_0\input'
        out_path = r'C:\Users\Assistenz\Desktop\Mauro\radiation_visualization\ASF_45_0\output'
    
    elif PATH == "2":
    
        in_path = r'C:\Users\Assistenz\Desktop\Mauro\radiation_visualization\ASF_noRef\input'
        out_path = r'C:\Users\Assistenz\Desktop\Mauro\radiation_visualization\ASF_noRef\output'
    ...
    '''
    # give a path with "sen_x,..." columns to calculate where the camera goes
    axes, mid_point = xy_axis(os.path.join(out_path, 'Room_sen_df.csv'))
