...
if not os.path.isfile(paths['PV'] + '\PV_electricity_results.npy'): 
    ...
    if createPlots:
        ...
        asf_electricity_production(
                           ...
                           simulationOption = {'timePeriod' : '3months'},
...
for monthi in range(1,13):
    ...
    for HOD in hour_in_month[monthi]:
        ...
        ii= 0
        hourlyData[monthi][HOD]['PV'] = 0.001 * PV_electricity_results['Pmpp_sum'][range((ii)*NumberCombinations, (ii+1)*NumberCombinations)] #evt. noch +1
        ii += 1
