...
if not os.path.isdir(paths['main'] + '\\Results_' + now):
    os.makedirs(paths['main'] + '\\Results_' + now)    
# save all results

Building_Simulation_df.to_csv(paths['main'] + '\\Results_' + now + '\\Building_Simulation.csv')
hourlyData_df.to_csv(paths['main'] + '\\Results_' + now + '\\hourlyData.csv')
...
#create folder to save figures as png:
os.makedirs(paths['main'] + '\\Results_' + now + '\\png' )
fig0.savefig(paths['main'] + '\\Results_' + now + '\\png\\' + 'figure0' + '.png')
fig1.savefig(paths['main'] + '\\Results_' + now + '\\png\\' + 'figure1' + '.png')
fig2.savefig(paths['main'] + '\\Results_' + now + '\\png\\' + 'figure2' + '.png')
fig3.savefig(paths['main'] + '\\Results_' + now + '\\png\\' + 'figure3' + '.png')
fig4.savefig(paths['main'] + '\\Results_' + now + '\\png\\' + 'figure4' + '.png')
