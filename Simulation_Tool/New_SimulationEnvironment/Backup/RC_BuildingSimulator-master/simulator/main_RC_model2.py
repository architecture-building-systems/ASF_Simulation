...
def main_RC_model (start, end, HOY_night, NumberCombinations, BuildingRadiationData_HOY, epw_name, myfilename1, myfilename2):
    ...
    Data_Heating_Combinations = {}
    Data_Cooling_Combinations = {}
    Data_Lighting_Combinations = {}
    Data_T_in_Combinations = {}
    ...
    for HOY in range(start,end):
        ...
        if HOY_night[HOY] != True:       
            #print '1', Q_fenstRad[0][HOY]        
            for combinations in range(0,NumberCombinations): #Angle Combinations
                ...
                Data_T_in=[] 
                Data_Heating=np.empty([NoHours])
                Data_Cooling=np.empty([NoHours])
                Data_Lighting=np.empty([NoHours])
                Data_uncomfortHours=np.zeros([NoHours])
                uncomfortHours=0
                ...
                #print '2', Q_fenstRad[0][HOY]
                
                Q_fenstRad[0][HOY]=BuildingRadiationData_HOY[HOY][combinations] #Solar Gains from ladybug analysis
                
                #print '3', Q_fenstRad[0][HOY]
                ...
                for ii in range(0,8760): #evaluate needed range (HOY=)             
                ...
                Data_Heating_Combinations[combinations]= Data_Heating[HOY]
                Data_Cooling_Combinations[combinations] = Data_Cooling[HOY]
                Data_Lighting_Combinations[combinations] = Data_Lighting[HOY]
                Data_T_in_Combinations[combinations] = Data_T_in[HOY]
                
                              
              
            Data_Heating_HOY[HOY] = Data_Heating_Combinations
            Data_Cooling_HOY[HOY] = Data_Cooling_Combinations
            Data_Lighting_HOY[HOY] = Data_Lighting_Combinations
            Data_T_in_HOY[HOY] = Data_T_in_Combinations
            ...
            #print "HOY Data", Data_Heating_HOY, Data_Cooling_HOY, Data_Lighting_HOY, Data_T_in_HOY 
            
        return Data_T_in, Data_Heating_HOY, Data_Cooling_HOY, Data_Lighting_HOY    
    
    else:
        Data_T_in, Data_Heating_HOY, Data_Cooling_HOY, Data_Lighting_HOY
        return Data_T_in, Data_Heating_HOY, Data_Cooling_HOY, Data_Lighting_HOY
