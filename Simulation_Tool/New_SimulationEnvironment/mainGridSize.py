...
'DataName' : 'ZH13_9comb_gridSize_month7_day4',
...
GridSize = [400,350,300,250,200,150,100,50,25]

###############################################################################

def MainCalculateASF(SimulationPeriod, SimulationData, PanelData, BuildingData, BuildingProperties, SimulationOptions, GridSize):
    
    # add python_path to system path, so that all files are available:
    sys.path.insert(0, os.path.abspath(os.path.dirname(sys.argv[0])))
    sys.path.insert(0, os.path.join(os.path.abspath(os.path.dirname(sys.argv[0])), 'python'))
    
    from FunctionsGridSize import initializeSimulation, initializeASF, setBuildingParameters, initializeBuildingSimulation, setPaths, CalculateVariables  
    from FunctionsGridSize import PrepareRadiationData, runRadiationCalculation
    ...
    HourlyRadiation, now = runRadiationCalculation(
...
#                            start = start, end = end)
    ...
    return BuildingRadiationHOY                      
    

BuildingRadiationHOY = MainCalculateASF(SimulationPeriod, SimulationData, PanelData, BuildingData, BuildingProperties, SimulationOptions)
#PV_Data, BuildingRadiationHOY, PV_electricity_results = MainCalculateASF(SimulationPeriode, SimulationData, PanelData, BuildingData, BuildingProperties, SimulationOptions)