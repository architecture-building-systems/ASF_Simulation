...
\label{s:baseCase}
	...
	\begin{figure*}
		\begin{center}
		\includegraphics[width=\textwidth, trim= 1cm 0.5cm 1cm 1.3cm,clip]{monthly_altitude2}
	...
	\begin{figure*}
		\begin{center}
		\includegraphics[width=\textwidth, trim= 1cm 0.5cm 1cm 1.3cm,clip]{monthly_azimuth2}
	...
	\begin{figure*}[b!!]
		\begin{center}
		\includegraphics[width=\textwidth, trim= 1cm 0.5cm 1cm 1.4cm,clip]{monthly_energy_perArea2}
...
\label{s:actuation}
	...
	\begin{figure*}[h!]
		\begin{center}
		\includegraphics[width=1\textwidth, trim= 0cm 0cm 0cm 0cm,clip]{3d7.png}
